...
| **4** | **Calendar providers** — Google, Microsoft, CalDAV | `GAP-0002`, reserved. The first item handling third-party credentials, so the first with a genuinely new harm surface. |
