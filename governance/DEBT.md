...
| **What remains open, and it is narrow** | Three blanks that only a person can fill: the **legal entity name and registered address**, the **governing law and supervisory authority**, and the **international transfer mechanism** relied upon. Plus a review by counsel, which has still not happened. These are `HUMAN.md` items; agents have drafted everything around them. |
