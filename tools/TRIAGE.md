...
events plus a daily sweep, checks this repository out alongside, and runs:
    ...
    claude -p "Follow governance/tools/TRIAGE.md"
...
- **Read first, from this repository:** `MANDATE.md` · `DECISIONS.md` ·
  `HUMAN.md` · `governance/CHARTER.md` Part 3 · `lessons/README.md`. Never
